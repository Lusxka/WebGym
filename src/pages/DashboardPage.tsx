...
export const DashboardPage: React.FC = () => {
  ...
  if (state.loading) {
    // CORREÇÃO: Fundo da tela de carregamento com contraste
    return <div className="flex h-screen w-full items-center justify-center bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">Carregando perfil...</div>;
  }

  return (
    // CORREÇÃO: Fundo da página com cinza claro para contraste
    <div className="flex h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-500">
      <Sidebar
        activeTab={activeTab}
        onTabChange={(tab) => {
          setActiveTab(tab);
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* CORREÇÃO: Header com cores para os dois modos */}
        <header className="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">WebGym</h1>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <p className="text-gray-900 dark:text-white font-medium">{state.user?.nome}</p>
              </div>
            </div>
          </div>
        </header>
